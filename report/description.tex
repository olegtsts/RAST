...
\begin{itemize}
	...
	\item call $ProcessShardGroup(group.can\_be\_updated, group.data)$
	\item for each shard in group calls $ProcessShard(group.can\_be\_updated, shard.data, group.data)$
