...
Let us introduce $RAFTCoreMP$ class, which is a \fullref{subsec:message_processor}, which controls consensus algorithm.
...
\begin{itemize}
	\item $transaction\_id$ of message to mark read
\end{itemize}
...
\begin{itemize}
	...
	\item $max\_saved$ is an iterator to the WAL, which points to the last saved entry
\end{itemize}
