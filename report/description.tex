...
\begin{itemize}
	\item \hyperref[subsec:low_overhead_periodic_timer]{periodic timer}
	\item \hyperref[subsec:low_overhead_start_finish_timer]{start-finish timer}
	\item \hyperref[subsec:low_overhead_waiting_timer]{waiting timer}
\end{itemize}
