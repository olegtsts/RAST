...
private:
    ...
    // 5 bytes for size covers 1TB of memory.
...
private:
    static constexpr size_t max_segment_size = 1000000000000;
    static constexpr size_t min_segment_size = 10000000;
    // Offset is 2**63 to avoid negative counter values.
    static constexpr int64_t usage_counter_offset = 140737488355328ll;
